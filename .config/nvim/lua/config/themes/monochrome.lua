...
function M.load()
	...
	local O = {
		...
		-- PLUGIN: Notify
		-- ========================================
		SnacksNotifierBorderError = { fg = c.destructive },
		SnacksNotifierBorderWarn = { fg = c.warning },
		SnacksNotifierBorderInfo = { fg = c.primary },
		SnacksNotifierBorderDebug = { fg = c.mutedForeground },
		SnacksNotifierBorderTrace = { fg = c.mutedForeground },
		SnacksNotifierTitleError = { fg = c.destructive },
		SnacksNotifierTitleWarn = { fg = c.warning },
		SnacksNotifierTitleInfo = { fg = c.primary },
		SnacksNotifierTitleDebug = { fg = c.mutedForeground },
		SnacksNotifierTitleTrace = { fg = c.mutedForeground },
		SnacksNotifierIconError = { fg = c.destructive },
		SnacksNotifierIconWarn = { fg = c.warning },
		SnacksNotifierIconInfo = { fg = c.primary },
		SnacksNotifierIconDebug = { fg = c.mutedForeground },
		SnacksNotifierIconTrace = { fg = c.mutedForeground },
		SnacksNotifierError = { fg = c.foreground },
		SnacksNotifierWarn = { fg = c.foreground },
		SnacksNotifierInfo = { fg = c.foreground },
		SnacksNotifierDebug = { fg = c.foreground },
