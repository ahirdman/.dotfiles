...
-- 							icon = { " ", hl = "DashboardPink" },
-- 							key = "q",
-- 							desc = { "Quit", hl = "SnacksDashboardTitle" },
-- 							action = ":qa",
-- 						},
-- 					},
-- 					header = [[
...
-- 						--         --scale=max; sleep .1
-- 						--         ]],
-- 						cmd = "chafa /Users/ahirdman/mars.png --format=symbols --symbols=vhalf --fit-width --align=center --scale=max; sleep .1",
-- 						height = 17,
-- 						padding = 1,
-- 						pane = 1,
-- 					},
